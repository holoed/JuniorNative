...
env = toEnv [
  ...
  ("renderTreeMap", Set.fromList [] :=> tyLam (TyApp (TyCon "List") (tupleCon [TyCon "String", TyCon "String", TyCon "Int", TyCon "Double", TyCon "Double", TyCon "String"])) (TyApp (TyCon "Async") (TyCon "Unit"))),
