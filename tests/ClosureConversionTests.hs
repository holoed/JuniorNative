...
|]
    ...
    it "convert simple recursive function" $ do
      ...
      unlines xs `shouldBe` drop 1 [i|
let _f2 (_env, n) = 
    let anf_3 = let anf_0 = AppClosure ((==, GetEnv (\"eqT14\", _env))) in
                AppClosure (anf_0, n) in
    let anf_18 = let anf_4 = let anf_1 = AppClosure ((fromInteger, GetEnv (\"numT14\", _env))) in
                             let anf_2 = 0 in
                             AppClosure (anf_1, anf_2) in
                 AppClosure (anf_3, anf_4) in 
        if anf_18\n            then let anf_5 = AppClosure ((fromInteger, GetEnv (\"numT14\", _env))) in
                 let anf_6 = 1 in
                 AppClosure (anf_5, anf_6)
            else let anf_16 = let anf_7 = AppClosure (((*), GetEnv (\"numT14\", _env))) in
                              AppClosure (anf_7, n) in
                 let anf_17 = let anf_14 = let anf_8 = AppClosure ((fac, GetEnv (\"eqT14\", _env))) in
                                           AppClosure ((anf_8, GetEnv (\"numT14\", _env))) in
                              let anf_15 = let anf_12 = let anf_9 = AppClosure ((-, GetEnv (\"numT14\", _env))) in
                                                        AppClosure (anf_9, n) in
                                           let anf_13 = let anf_10 = AppClosure ((fromInteger, GetEnv (\"numT14\", _env))) in
                                                        let anf_11 = 1 in
                                                        AppClosure (anf_10, anf_11) in
                                           AppClosure (anf_12, anf_13) in
                              AppClosure (anf_14, anf_15) in
...
let main = 
    let anf_22 = let anf_19 = AppClosure (fac, eqInt) in
                 AppClosure (anf_19, numInt) in
    let anf_23 = let anf_20 = AppClosure (fromInteger, numInt) in
                 let anf_21 = 5 in
                 AppClosure (anf_20, anf_21) in
...
|]
    ...
    it "applied function" $ do
      ...
      unlines xs `shouldBe` drop 1 [i|
let _f1 (_env, x) = 
    let anf_3 = let anf_0 = AppClosure (((+), GetEnv (\"numT2\", _env))) in
                AppClosure (anf_0, x) in
    let anf_4 = let anf_1 = AppClosure ((fromInteger, GetEnv (\"numT2\", _env))) in
                let anf_2 = 1 in
                AppClosure (anf_1, anf_2) in
...
let main = let anf_7 = AppClosure (f, numInt) in
           let anf_8 = let anf_5 = AppClosure (fromInteger, numInt) in
                       let anf_6 = 5 in
                       AppClosure (anf_5, anf_6) in
